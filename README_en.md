...
* v1.3.7 (Build 20241112)
    ...
    * **Extended "！" Prefix Functionality**:  
        ...
        * Input after override(SOCD - after override) is now available for both keyboard keys and mouse buttons, ensuring seamless key remapping across physical and virtual devices.
...
* v1.3.7 (Build 20240928)
  ...
  * Introduced the "！" prefix for the "Mapped Key List" in the mapping settings window. This prefix can be added before a normal keyboard or mouse mapped key to implement input after override(SOCD - after override). For example:
