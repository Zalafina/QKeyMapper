...
public:
    ...
    static QPair<QString, QStringList> extractSpecialPatternsWithBracketBalancing(const QString &mappingKey, const QRegularExpression &sendtext_regex, const QRegularExpression &run_regex, const QRegularExpression &switchtab_regex, const QRegularExpression &unlock_regex, const QRegularExpression &setvolume_regex = QRegularExpression(), const QRegularExpression &repeat_regex = QRegularExpression());
