...
public:
    ...
    static QPair<QString, QStringList> extractSpecialPatternsWithBracketBalancing(
        ...
        const QRegularExpression &keysequencetoggle_regex,
        const QRegularExpression &keysequencepause_regex,
        const QRegularExpression &keysequencecontinue_regex,
...
private:
    int updateAllMappingInfoFinally(const QString &originalKey, const QString &mappingKey, const QString &mappingKey_KeyUp);
