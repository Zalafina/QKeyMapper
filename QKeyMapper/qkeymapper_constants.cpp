...
const char *KEYMAPDATA_DESCRIPTION = "KeyMapData_Description";
...
const char *ITEMDESCRIPTIONLABEL_CHINESE = "映射项描述";
...
const char *ITEMDESCRIPTIONLABEL_ENGLISH = "Description";
