...
const int BEST_ICON_SIZE = 256;
const int DEFAULT_ICON_WIDTH = 48;
const int DEFAULT_ICON_HEIGHT = 48;

const int COMBOBOX_BLANK_ICON_WIDTH = 16;
const int COMBOBOX_BLANK_ICON_HEIGHT = 16;
...
const int COLORPICKER_BUTTON_WIDTH_TABBGCOLOR = 101;
const int COLORPICKER_BUTTON_WIDTH_NOTIFICATION_FONTCOLOR = 61;
const int COLORPICKER_BUTTON_WIDTH_NOTIFICATION_BGCOLOR = 51;

const char *NOTIFICATION_COLOR_GLOBAL_DEFAULT_STR = "#26de81";
const char *NOTIFICATION_COLOR_NORMAL_DEFAULT_STR = "#d6a2e8";
const QColor NOTIFICATION_COLOR_GLOBAL_DEFAULT = QColor(38, 222, 129);
const QColor NOTIFICATION_COLOR_NORMAL_DEFAULT = QColor(214, 162, 232);
const QColor NOTIFICATION_BACKGROUND_COLOR_DEFAULT = QColor(0,0,0,180);

const int NOTIFICATION_FONT_SIZE_MIN = 1;
const int NOTIFICATION_FONT_SIZE_MAX = 72;
const int NOTIFICATION_FONT_SIZE_DEFAULT = 16;

const int NOTIFICATION_FONT_WEIGHT_LIGHT    = 0;
const int NOTIFICATION_FONT_WEIGHT_NORMAL   = 1;
const int NOTIFICATION_FONT_WEIGHT_BOLD     = 2;
const int NOTIFICATION_FONT_WEIGHT_DEFAULT  = NOTIFICATION_FONT_WEIGHT_BOLD;
const int NOTIFICATION_FONT_WEIGHT_MIN      = NOTIFICATION_FONT_WEIGHT_LIGHT;
const int NOTIFICATION_FONT_WEIGHT_MAX      = NOTIFICATION_FONT_WEIGHT_BOLD;

const bool NOTIFICATION_FONT_ITALIC_DEFAULT = false;
const int NOTIFICATION_DISPLAY_DURATION_DEFAULT = 3000;
const int NOTIFICATION_FADEIN_DURATION_DEFAULT = 0;
const int NOTIFICATION_FADEOUT_DURATION_DEFAULT = 500;
const double NOTIFICATION_OPACITY_DEFAULT = 1.0;
const int NOTIFICATION_PADDING_DEFAULT = 15;
const int NOTIFICATION_BORDER_RADIUS_DEFAULT = 5;
const int NOTIFICATION_X_OFFSET_DEFAULT = 0;
const int NOTIFICATION_Y_OFFSET_DEFAULT = 0;

const int NOTIFICATION_OPACITY_DECIMALS = 3;
const double NOTIFICATION_OPACITY_SINGLESTEP = 0.01;
const int NOTIFICATION_DURATION_MIN = 0;
const int NOTIFICATION_DURATION_MAX = 99999;
const double NOTIFICATION_OPACITY_MIN = 0.0;
const double NOTIFICATION_OPACITY_MAX = 1.0;
const int NOTIFICATION_PADDING_MIN = 0;
const int NOTIFICATION_PADDING_MAX = 1000;
const int NOTIFICATION_BORDER_RADIUS_MIN = 0;
const int NOTIFICATION_BORDER_RADIUS_MAX = 1000;
const int NOTIFICATION_OFFSET_MIN = -5000;
const int NOTIFICATION_OFFSET_MAX = 5000;

#if 0
const int TRAYICON_INDEX_BLACK = 0;
const int TRAYICON_INDEX_BLUE1 = 1;
const int TRAYICON_INDEX_BLUE2 = 2;
const int TRAYICON_INDEX_CYAN = 3;
const int TRAYICON_INDEX_GRAY1 = 4;
const int TRAYICON_INDEX_GRAY2 = 5;
const int TRAYICON_INDEX_GREEN1 = 6;
const int TRAYICON_INDEX_GREEN2 = 7;
const int TRAYICON_INDEX_ORANGE = 8;
const int TRAYICON_INDEX_PINK = 9;
const int TRAYICON_INDEX_PURPLE = 10;
const int TRAYICON_INDEX_RED = 11;
const int TRAYICON_INDEX_WHITE = 12;
const int TRAYICON_INDEX_YELLOW = 13;
...
#endif
const char *CUSTOM_TRAYICONS_DIR = "custom_trayicons";
const char *ICON_FILE_SUFFIX = ".ico";
const char *TRAYICON_IDLE_DEFAULT_FILE = ":/Blue1.ico";
const char *TRAYICON_MONITORING_DEFAULT_FILE = ":/Red.ico";
const char *TRAYICON_GLOBAL_DEFAULT_FILE = ":/Green1.ico";
const char *TRAYICON_MATCHED_DEFAULT_FILE = ":/Purple.ico";

const int TAB_CUSTOMIMAGE_WIDTH_DEFAULT = 48;
const int TAB_CUSTOMIMAGE_HEIGHT_DEFAULT = 48;
const int TAB_CUSTOMIMAGE_SHOW_NONE = 0;
const int TAB_CUSTOMIMAGE_SHOW_LEFT = 1;
const int TAB_CUSTOMIMAGE_SHOW_RIGHT = 2;
const int TAB_CUSTOMIMAGE_POSITION_MIN = TAB_CUSTOMIMAGE_SHOW_NONE;
const int TAB_CUSTOMIMAGE_POSITION_MAX = TAB_CUSTOMIMAGE_SHOW_RIGHT;
const int TAB_CUSTOMIMAGE_POSITION_DEFAULT = TAB_CUSTOMIMAGE_SHOW_NONE;
const int TAB_CUSTOMIMAGE_PADDING_MIN = 0;
const int TAB_CUSTOMIMAGE_PADDING_MAX = 1000;
const int TAB_CUSTOMIMAGE_PADDING_DEFAULT = 0;
const bool TAB_CUSTOMIMAGE_SHOW_AS_TRAYICON_DEFAULT = false;

const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_DEFAULT    = 0;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_16         = 1;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_24         = 2;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_32         = 3;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_48         = 4;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_64         = 5;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_96         = 6;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_128        = 7;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_256        = 8;

const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_MIN = TAB_CUSTOMIMAGE_TRAYICON_PIXEL_DEFAULT;
const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_MAX = TAB_CUSTOMIMAGE_TRAYICON_PIXEL_256;

const QHash<int, QSize> ICON_SIZE_MAP = {
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_DEFAULT, QSize()},
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_16, QSize(16, 16)},
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_24, QSize(24, 24)},
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_32, QSize(32, 32)},
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_48, QSize(48, 48)},
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_64, QSize(64, 64)},
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_96, QSize(96, 96)},
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_128, QSize(128, 128)},
    {TAB_CUSTOMIMAGE_TRAYICON_PIXEL_256, QSize(256, 256)}
};

const char *CROSSHAIR_CENTERCOLOR_DEFAULT = "70a1ff";
const char *CROSSHAIR_CROSSHAIRCOLOR_DEFAULT = "70a1ff";
const QColor CROSSHAIR_CENTERCOLOR_DEFAULT_QCOLOR = QColor(112, 161, 255);
const QColor CROSSHAIR_CROSSHAIRCOLOR_DEFAULT_QCOLOR = QColor(112, 161, 255);
...
const int JOYSTICK_INVALID_INSTANCE_ID = -1;
...
const double GYRO2MOUSE_GYRO_SENS_MIN = 0.0;
const double GYRO2MOUSE_GYRO_SENS_MAX = 200.0;
const double GYRO2MOUSE_GYRO_SENS_SINGLESTEP = 0.1;
const double GYRO2MOUSE_MIN_GYRO_SENS_DEFAULT = 7.0;
const double GYRO2MOUSE_MAX_GYRO_SENS_DEFAULT = 15.0;

const double GYRO2MOUSE_GYRO_THRESHOLD_MIN = 0.0;
const double GYRO2MOUSE_GYRO_THRESHOLD_MAX = 500.0;
const double GYRO2MOUSE_GYRO_THRESHOLD_SINGLESTEP = 0.1;
const double GYRO2MOUSE_MIN_GYRO_THRESHOLD_DEFAULT = 1.5;
const double GYRO2MOUSE_MAX_GYRO_THRESHOLD_DEFAULT = 15.0;
...
const uint VJOY_STICK_RADIUS_MIN  = 0;
const uint VJOY_STICK_RADIUS_MAX  = 255;
...
const int FIXED_VIRTUAL_KEY_CODE_NONE       = 0x00;
...
// const char *WINDOWSWITCHKEYLABEL_ENGLISH = "ShowHideKey";
// const char *MAPPINGSTARTKEYLABEL_ENGLISH = "StartKey";
// const char *MAPPINGSTOPKEYLABEL_ENGLISH = "StopKey";
...
// const char *SETTINGTAB_VGAMEPAD_ENGLISH = "VirtualGamepad";
