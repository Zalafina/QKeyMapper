...
const QColor NOTIFICATION_BACKGROUND_COLOR_DEFAULT = QColor(0,0,0,120);
...
const int NOTIFICATION_OPACITY_DECIMALS = 2;
...
const bool TAB_CUSTOMIMAGE_SHOW_AS_FLOATINGWINDOW_DEFAULT = false;

const char *ICON_SIZE_SEPARATORT = "×";

const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_INDEX_DEFAULT = 0;

const QPoint FLOATINGICONWINDOW_POSITION_MIN = QPoint(-50000, -50000);
const QPoint FLOATINGICONWINDOW_POSITION_MAX = QPoint(50000, 50000);
const QPoint FLOATINGICONWINDOW_POSITION_DEFAULT = QPoint(50, 50);

const int FLOATINGICONWINDOW_SIZE_MIN = 20;
const int FLOATINGICONWINDOW_SIZE_MAX = 600;
const QSize FLOATINGICONWINDOW_SIZE_DEFAULT = QSize(64, 64);

const int FLOATINGICONWINDOW_OPACITY_DECIMALS = 2;
const double FLOATINGICONWINDOW_OPACITY_SINGLESTEP = 0.01;
const double FLOATINGICONWINDOW_OPACITY_MIN = 0.1;
const double FLOATINGICONWINDOW_OPACITY_MAX = 1.0;
const double FLOATINGICONWINDOW_OPACITY_DEFAULT = 1.0;
