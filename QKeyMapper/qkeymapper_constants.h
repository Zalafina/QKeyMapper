...
extern const int KEY_TYPE_GAMEPAD;
extern const int KEY_TYPE_FUNCTION;
...
extern const int SYSTRAY_MENU_ITEM_PRESSED_NONE;
extern const int SYSTRAY_MENU_ITEM_PRESSED_SHOWHIDE;
extern const int SYSTRAY_MENU_ITEM_PRESSED_QUIT;
...
extern const int LANGUAGE_JAPANESE;
...
extern const int WINDOWINFO_MATCH_INDEX_IGNORE;
extern const int WINDOWINFO_MATCH_INDEX_EQUALS;
extern const int WINDOWINFO_MATCH_INDEX_CONTAINS;
...
extern const int COLORPICKER_BUTTON_WIDTH_TABFONTCOLOR;
extern const int COLORPICKER_BUTTON_WIDTH_TABBGCOLOR;
extern const int COLORPICKER_BUTTON_WIDTH_NOTIFICATION_FONTCOLOR;
extern const int COLORPICKER_BUTTON_WIDTH_NOTIFICATION_BGCOLOR;
extern const char *NOTIFICATION_COLOR_GLOBAL_DEFAULT_STR;
extern const char *NOTIFICATION_COLOR_NORMAL_DEFAULT_STR;
extern const QColor NOTIFICATION_COLOR_GLOBAL_DEFAULT;
extern const QColor NOTIFICATION_COLOR_NORMAL_DEFAULT;
extern const QColor NOTIFICATION_BACKGROUND_COLOR_DEFAULT;
extern const int NOTIFICATION_FONT_SIZE_MIN;
extern const int NOTIFICATION_FONT_SIZE_MAX;
extern const int NOTIFICATION_FONT_SIZE_DEFAULT;
extern const int NOTIFICATION_FONT_WEIGHT_LIGHT;
extern const int NOTIFICATION_FONT_WEIGHT_NORMAL;
extern const int NOTIFICATION_FONT_WEIGHT_BOLD;
extern const int NOTIFICATION_FONT_WEIGHT_DEFAULT;
extern const int NOTIFICATION_FONT_WEIGHT_MIN;
extern const int NOTIFICATION_FONT_WEIGHT_MAX;
extern const bool NOTIFICATION_FONT_ITALIC_DEFAULT;
extern const int NOTIFICATION_DISPLAY_DURATION_DEFAULT;
extern const int NOTIFICATION_FADEIN_DURATION_DEFAULT;
extern const int NOTIFICATION_FADEOUT_DURATION_DEFAULT;
extern const double NOTIFICATION_OPACITY_DEFAULT;
extern const int NOTIFICATION_PADDING_DEFAULT;
extern const int NOTIFICATION_BORDER_RADIUS_DEFAULT;
extern const int NOTIFICATION_X_OFFSET_DEFAULT;
extern const int NOTIFICATION_Y_OFFSET_DEFAULT;
extern const int NOTIFICATION_OPACITY_DECIMALS;
extern const double NOTIFICATION_OPACITY_SINGLESTEP;
extern const int NOTIFICATION_DURATION_MIN;
extern const int NOTIFICATION_DURATION_MAX;
extern const double NOTIFICATION_OPACITY_MIN;
extern const double NOTIFICATION_OPACITY_MAX;
extern const int NOTIFICATION_PADDING_MIN;
extern const int NOTIFICATION_PADDING_MAX;
extern const int NOTIFICATION_BORDER_RADIUS_MIN;
...
extern const int TRAYICON_INDEX_GREEN2;
extern const int TRAYICON_INDEX_ORANGE;
extern const int TRAYICON_INDEX_PINK;
extern const int TRAYICON_INDEX_PURPLE;
extern const int TRAYICON_INDEX_RED;
extern const int TRAYICON_INDEX_WHITE;
extern const int TRAYICON_INDEX_YELLOW;
extern const int TRAYICON_INDEX_MIN;
extern const int TRAYICON_INDEX_MAX;
extern const int TRAYICON_IDLE_DEFAULT;
...
extern const int TAB_CUSTOMIMAGE_SHOW_LEFT;
extern const int TAB_CUSTOMIMAGE_SHOW_RIGHT;
extern const int TAB_CUSTOMIMAGE_POSITION_MIN;
extern const int TAB_CUSTOMIMAGE_POSITION_MAX;
extern const int TAB_CUSTOMIMAGE_POSITION_DEFAULT;
extern const int TAB_CUSTOMIMAGE_PADDING_MIN;
extern const int TAB_CUSTOMIMAGE_PADDING_MAX;
extern const int TAB_CUSTOMIMAGE_PADDING_DEFAULT;
extern const bool TAB_CUSTOMIMAGE_SHOW_AS_TRAYICON_DEFAULT;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_DEFAULT;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_16;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_24;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_32;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_48;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_64;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_96;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_128;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_256;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_MIN;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_MAX;
extern const QHash<int, QSize> ICON_SIZE_MAP;
extern const char *CROSSHAIR_CENTERCOLOR_DEFAULT;
extern const char *CROSSHAIR_CROSSHAIRCOLOR_DEFAULT;
extern const QColor CROSSHAIR_CENTERCOLOR_DEFAULT_QCOLOR;
extern const QColor CROSSHAIR_CROSSHAIRCOLOR_DEFAULT_QCOLOR;
...
extern const int GAMEPADINFO_GYRO_NONE;
...
extern const int GYRO2MOUSE_MOUSE_INPUT_SOURCE_GYRO_X;
extern const int GYRO2MOUSE_MOUSE_INPUT_SOURCE_GYRO_Y;
extern const int GYRO2MOUSE_MOUSE_INPUT_SOURCE_GYRO_Z;

extern const int GYRO2MOUSE_MOUSE_X_INPUT_SOURCE_DEFAULT;
extern const int GYRO2MOUSE_MOUSE_Y_INPUT_SOURCE_DEFAULT;
...
extern const char *LANGUAGECODE_JAPANESE;
...
extern const char *NOTIFICATION_FONTCOLOR;
extern const char *NOTIFICATION_FONTSIZE;
extern const char *NOTIFICATION_FONTWEIGHT;
extern const char *NOTIFICATION_FONTITALIC;
extern const char *NOTIFICATION_DISPLAYDURATION;
extern const char *NOTIFICATION_FADEINDURATION;
extern const char *NOTIFICATION_FADEOUTDURATION;
extern const char *NOTIFICATION_BACKGROUNDCOLOR;
extern const char *NOTIFICATION_BORDERRADIUS;
extern const char *NOTIFICATION_PADDING;
extern const char *NOTIFICATION_OPACITY;
extern const char *NOTIFICATION_X_OFFSET;
extern const char *NOTIFICATION_Y_OFFSET;
extern const char *TRAYICON_IDLE;
extern const char *TRAYICON_MONITORING;
extern const char *TRAYICON_GLOBAL;
extern const char *TRAYICON_MATCHED;
...
extern const char *STARTUP_AUTOMONITORING;
...
extern const char *GYRO2MOUSE_MIN_GYRO_X_SENSITIVITY;
extern const char *GYRO2MOUSE_MIN_GYRO_Y_SENSITIVITY;
extern const char *GYRO2MOUSE_MAX_GYRO_X_SENSITIVITY;
extern const char *GYRO2MOUSE_MAX_GYRO_Y_SENSITIVITY;
extern const char *GYRO2MOUSE_MIN_GYRO_THRESHOLD;
extern const char *GYRO2MOUSE_MAX_GYRO_THRESHOLD;
extern const char *GYRO2MOUSE_MOUSE_X_SOURCE;
extern const char *GYRO2MOUSE_MOUSE_Y_SOURCE;
extern const char *GYRO2MOUSE_MOUSE_X_REVERT;
extern const char *GYRO2MOUSE_MOUSE_Y_REVERT;
#ifdef VIGEM_CLIENT_SUPPORT
...
extern const char *MAPPINGTABLE_TABFONTCOLORLIST;
extern const char *MAPPINGTABLE_TABBGCOLORLIST;
extern const char *MAPPINGTABLE_TABCUSTOMIMAGE_PATHLIST;
extern const char *MAPPINGTABLE_TABCUSTOMIMAGE_SHOWPOSITIONLIST;
extern const char *MAPPINGTABLE_TABCUSTOMIMAGE_PADDINGLIST;
extern const char *MAPPINGTABLE_TABCUSTOMIMAGE_SHOWASTRAYICONLIST;
extern const char *MAPPINGTABLE_TABCUSTOMIMAGE_TRAYICON_PIXELLIST;
...
extern const char *PROCESSINFO_FILENAME_MATCH_INDEX;
extern const char *PROCESSINFO_WINDOWTITLE_MATCH_INDEX;
...
extern const char *MAPPINGKEYUNLOCKCHECKBOX_STR;
extern const char *POSTMAPPINGKEYCHECKBOX_STR;
extern const char *CHECKCOMBKEYORDERCHECKBOX_STR;
extern const char *UNBREAKABLECHECKBOX_STR;
extern const char *PASSTHROUGHCHECKBOX_STR;
extern const char *KEYSEQHOLDDOWNCHECKBOX_STR;
extern const char *REPEATBYKEYCHECKBOX_STR;
extern const char *REPEATBYTIMESCHECKBOX_STR;
extern const char *BURSTPRESSLABEL_STR;
extern const char *BURSTRELEASE_STR;
extern const char *ORIGINALKEYLABEL_STR;
extern const char *MAPPINGKEYLABEL_STR;
extern const char *KEYUPMAPPINGLABEL_STR;
