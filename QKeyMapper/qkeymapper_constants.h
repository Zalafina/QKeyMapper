...
namespace QKeyMapperConstants {
    ...
    inline constexpr int MAPPINGSEQUENCEEDIT_TYPE_MACROLIST_MACROCONTENT_DIRECT  = 3;
    ...
    inline constexpr const char FLOATINGWINDOW_MOUSE_PASSTHROUGH_SWITCHKEY_DEFAULT[]  = "F3";
    ...
    inline constexpr const char COMMONMAPPINGDATA[] = "CommonMappingData";
    ...
    inline constexpr const char GENERAL_SAVESETTING_HOTKEY[]                = "Ctrl+S";
    ...
    inline constexpr const char KEYLISTCOMBOBOX_COPY_KEY_NAME_HOTKEY[]      = "Ctrl+C";
    ...
    inline constexpr const char ONLYONCE_STR[]          = "OnlyOnce";
    ...
    inline constexpr const char VJOY_LT_MAX_STR[] = "vJoy-LT-Max";
    inline constexpr const char VJOY_RT_MAX_STR[] = "vJoy-RT-Max";
    ...
    inline constexpr const char GAMEPAD_TOUCHPAD_ON_NOTIFY_KEY_STR[] = "GamepadTouchpadOn🎮";
