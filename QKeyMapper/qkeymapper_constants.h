...
extern const int NOTIFICATION_DURATION_DEFAULT;
...
extern const int NOTIFICATION_SIZE_MIN;
extern const int NOTIFICATION_SIZE_MAX;
extern const int NOTIFICATION_SIZE_DEFAULT;
