...
extern const bool TAB_CUSTOMIMAGE_SHOW_AS_FLOATINGWINDOW_DEFAULT;
extern const char *ICON_SIZE_SEPARATORT;
extern const int TAB_CUSTOMIMAGE_TRAYICON_PIXEL_INDEX_DEFAULT;
extern const QPoint FLOATINGICONWINDOW_POSITION_MIN;
extern const QPoint FLOATINGICONWINDOW_POSITION_MAX;
extern const QPoint FLOATINGICONWINDOW_POSITION_DEFAULT;
extern const int FLOATINGICONWINDOW_SIZE_MIN;
extern const int FLOATINGICONWINDOW_SIZE_MAX;
extern const QSize FLOATINGICONWINDOW_SIZE_DEFAULT;
extern const int FLOATINGICONWINDOW_OPACITY_DECIMALS;
extern const double FLOATINGICONWINDOW_OPACITY_SINGLESTEP;
extern const double FLOATINGICONWINDOW_OPACITY_MIN;
extern const double FLOATINGICONWINDOW_OPACITY_MAX;
extern const double FLOATINGICONWINDOW_OPACITY_DEFAULT;
...
extern const char *MAPPINGTABLE_TABCUSTOMIMAGE_SHOWASFLOATINGWINDOWLIST;
extern const char *MAPPINGTABLE_TABCUSTOMIMAGE_TRAYICON_PIXELLIST;
extern const char *MAPPINGTABLE_FLOATINGWINDOW_POSITIONLIST;
extern const char *MAPPINGTABLE_FLOATINGWINDOW_SIZELIST;
extern const char *MAPPINGTABLE_FLOATINGWINDOW_OPACITYLIST;
