...
* v1.3.6(Build 20240303)
    ...
    * 为鼠标控制虚拟游戏手柄左/右摇杆的功能(Mouse2Joystick)添加了两个可映射的控制按键，Mouse2vJoy-Hold(按下后当前的摇杆偏移保持不再变化)，Mouse2vJoy-Direct(按下后摇杆偏移跟随鼠标移动方向变化，按键抬起后摇杆偏移归0)。
